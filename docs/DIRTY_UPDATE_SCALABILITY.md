...
- Collision, shadow proxy, upload budget, and visual parity coverage under true many-edit runtime bursts beyond the current edge-matrix and pressure dirty lanes.
