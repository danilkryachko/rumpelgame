...
- `handoff_gpu_report_freshness=guarded`
- `rc_test_gpu_report_freshness=guarded`
- `rc_security_deterministic_property_tests=guarded`
- `security_observability_gpu_report_freshness=guarded`
- `security_storage_package_smoke=guarded`
- `security_packet_error_monitoring=export_ready`
- `security_server_session_monitoring=export_ready`
...
- `security_worldgen_biome_atlas_tile_identity=guarded`
- `security_worldgen_biome_atlas_block_texture_usage=guarded`
- `security_overload_status=admission_matrix_guarded`
- `security_runtime_reconnect=repeated_live_rebootstrap_guarded`
- `security_reconnect_smoke_status=pass`
- `security_reconnect_soak_status=pass`
- `security_slow_client_status=load_matrix_guarded`
...
- `rc_security_observability_gpu_report_freshness=guarded`
- `rc_security_storage_package_smoke=guarded`
- `rc_security_packet_error_monitoring=export_ready`
- `rc_security_server_session_monitoring=export_ready`
...
- `rc_security_worldgen_biome_atlas_tile_identity=guarded`
- `rc_security_worldgen_biome_atlas_block_texture_usage=guarded`
...
- `rc_security_slow_client_status=load_matrix_guarded`
...
- `external_rc_test_gpu_report_freshness=guarded`
- `external_rc_security_observability_gpu_report_freshness=guarded`
- `external_rc_security_packet_error_monitoring=export_ready`
- `external_rc_security_server_session_monitoring=export_ready`
...
- `external_rc_security_worldgen_biome_atlas_tile_identity=guarded`
- `external_rc_security_worldgen_biome_atlas_block_texture_usage=guarded`
- `external_rc_security_overload_status=admission_matrix_guarded`
- `external_rc_security_runtime_reconnect=repeated_live_rebootstrap_guarded`
- `external_rc_security_reconnect_smoke_status=pass`
- `external_rc_security_reconnect_soak_status=pass`
- `external_rc_security_slow_client_status=load_matrix_guarded`
