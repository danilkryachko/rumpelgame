...
- Next useful GPU step: implement the first partial dirty-upload slice on top of this baseline, starting with limiting GPU mesh updates to dirty/rebuild subchunks while keeping the existing full chunk replacement path as rollback/control.
