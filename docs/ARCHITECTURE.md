...
- Server client sessions own the placement inventory and player-body collision boundary for `BlockAction_PLACE` and counted break-drop insertion for `BlockAction_DESTROY`.
