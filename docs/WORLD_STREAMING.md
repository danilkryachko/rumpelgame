...
- `logs/server_scalability_pass_current/server-scalability-pass-summary.txt` reported `status=pass`, `scalability_status=repeat_live_guarded`, `resource_profile_status=repeat_live_guarded`, `admission_policy=live_guarded`, `disconnect_cleanup_status=lifecycle_summary_guarded`, `live_load_status=pass`, `live_detail_status=pass`, `live_detail_clients=2`, `live_resource_samples=7`, `live_resource_rss_kb_max=26512`, `broader_live_load_status=pass`, `broader_live_clients=6`, `broader_live_initial_chunks=6`, `broader_live_fanout_updates=6`, `broader_live_detail_status=pass`, `broader_live_detail_clients=6`, `broader_live_resource_samples=6`, `broader_live_resource_rss_kb_max=31584`, `repeat_smoke_status=pass`, `repeat_smoke_repeats=3`, `repeat_smoke_initial_chunks=18`, `repeat_smoke_fanout_updates=18`, `repeat_smoke_detail_clients=18`, `repeat_smoke_resource_samples=9`, `repeat_smoke_max_rss_kb=31120`, `admission_limit_smoke_status=pass`, `admission_limit_rejected_clients=1`, `connection_lifecycle_status=pass`, `connection_lifecycle_close_failures=0`, and `active_protocol_change=0`.
