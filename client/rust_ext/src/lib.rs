...
impl GpuNativeShadowResourceDescriptor {
    fn new(shadow_radius_chunks: i32) -> Self {
        ...
        Self {
            ...
            bytes_per_texel,
            estimated_bytes: u64::from(map_size_px)
                * u64::from(map_size_px)
