...
security_observability_gpu_report_freshness="$(field_metric observability_gpu_report_freshness "$SECURITY_SUMMARY")"
...
security_worldgen_biome_atlas_tile_identity="$(field_metric worldgen_biome_atlas_tile_identity "$SECURITY_SUMMARY")"
security_worldgen_biome_atlas_block_texture_usage="$(field_metric worldgen_biome_atlas_block_texture_usage "$SECURITY_SUMMARY")"
security_overload_status="$(field_metric overload_status "$SECURITY_SUMMARY")"
security_runtime_reconnect="$(field_metric runtime_reconnect "$SECURITY_SUMMARY")"
security_reconnect_smoke_status="$(field_metric reconnect_smoke_status "$SECURITY_SUMMARY")"
security_reconnect_smoke_client_state="$(field_metric reconnect_smoke_client_state "$SECURITY_SUMMARY")"
security_reconnect_smoke_reader_errors="$(field_metric reconnect_smoke_reader_errors "$SECURITY_SUMMARY")"
security_reconnect_smoke_successes="$(field_metric reconnect_smoke_successes "$SECURITY_SUMMARY")"
security_reconnect_soak_status="$(field_metric reconnect_soak_status "$SECURITY_SUMMARY")"
security_reconnect_soak_cycles="$(field_metric reconnect_soak_cycles "$SECURITY_SUMMARY")"
security_reconnect_soak_reader_errors="$(field_metric reconnect_soak_reader_errors "$SECURITY_SUMMARY")"
security_reconnect_soak_successes="$(field_metric reconnect_soak_successes "$SECURITY_SUMMARY")"
security_slow_client_status="$(field_metric slow_client_status "$SECURITY_SUMMARY")"
security_slow_reader_smoke_status="$(field_metric slow_reader_smoke_status "$SECURITY_SUMMARY")"
security_slow_reader_timeout_observed="$(field_metric slow_reader_timeout_observed "$SECURITY_SUMMARY")"
security_slow_reader_timeout_class="$(field_metric slow_reader_timeout_class "$SECURITY_SUMMARY")"
security_slow_reader_matrix_status="$(field_metric slow_reader_matrix_status "$SECURITY_SUMMARY")"
security_slow_reader_matrix_counts_checked="$(field_metric slow_reader_matrix_counts_checked "$SECURITY_SUMMARY")"
security_slow_reader_matrix_max_fast_clients="$(field_metric slow_reader_matrix_max_fast_clients "$SECURITY_SUMMARY")"
security_slow_reader_matrix_total_fast_clients="$(field_metric slow_reader_matrix_total_fast_clients "$SECURITY_SUMMARY")"
security_slow_reader_matrix_total_fast_bootstrap_chunks="$(field_metric slow_reader_matrix_total_fast_bootstrap_chunks "$SECURITY_SUMMARY")"
security_slow_reader_matrix_total_slow_timeouts="$(field_metric slow_reader_matrix_total_slow_timeouts "$SECURITY_SUMMARY")"
...
rc_security_observability_gpu_report_freshness="$(field_metric security_observability_gpu_report_freshness "$RC_SUMMARY")"
...
external_rc_security_observability_gpu_report_freshness="$(field_metric rc_security_observability_gpu_report_freshness "$EXTERNAL_PROFILING_SUMMARY")"
...
external_rc_security_worldgen_biome_atlas_tile_identity="$(field_metric rc_security_worldgen_biome_atlas_tile_identity "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_worldgen_biome_atlas_block_texture_usage="$(field_metric rc_security_worldgen_biome_atlas_block_texture_usage "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_overload_status="$(field_metric rc_security_overload_status "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_runtime_reconnect="$(field_metric rc_security_runtime_reconnect "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_reconnect_smoke_status="$(field_metric rc_security_reconnect_smoke_status "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_reconnect_smoke_client_state="$(field_metric rc_security_reconnect_smoke_client_state "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_reconnect_smoke_reader_errors="$(field_metric rc_security_reconnect_smoke_reader_errors "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_reconnect_smoke_successes="$(field_metric rc_security_reconnect_smoke_successes "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_reconnect_soak_status="$(field_metric rc_security_reconnect_soak_status "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_reconnect_soak_cycles="$(field_metric rc_security_reconnect_soak_cycles "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_reconnect_soak_reader_errors="$(field_metric rc_security_reconnect_soak_reader_errors "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_reconnect_soak_successes="$(field_metric rc_security_reconnect_soak_successes "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_slow_client_status="$(field_metric rc_security_slow_client_status "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_slow_reader_smoke_status="$(field_metric rc_security_slow_reader_smoke_status "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_slow_reader_timeout_observed="$(field_metric rc_security_slow_reader_timeout_observed "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_slow_reader_timeout_class="$(field_metric rc_security_slow_reader_timeout_class "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_slow_reader_matrix_status="$(field_metric rc_security_slow_reader_matrix_status "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_slow_reader_matrix_counts_checked="$(field_metric rc_security_slow_reader_matrix_counts_checked "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_slow_reader_matrix_max_fast_clients="$(field_metric rc_security_slow_reader_matrix_max_fast_clients "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_slow_reader_matrix_total_fast_clients="$(field_metric rc_security_slow_reader_matrix_total_fast_clients "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_slow_reader_matrix_total_fast_bootstrap_chunks="$(field_metric rc_security_slow_reader_matrix_total_fast_bootstrap_chunks "$EXTERNAL_PROFILING_SUMMARY")"
external_rc_security_slow_reader_matrix_total_slow_timeouts="$(field_metric rc_security_slow_reader_matrix_total_slow_timeouts "$EXTERNAL_PROFILING_SUMMARY")"
...

{
  ...
  printf 'row=storage_protocol_integrity status=%s active_protocol_change=%s observability_gpu_report_freshness=%s storage_package_smoke=%s packet_error_monitoring=%s server_session_monitoring=%s storage_config=%s storage_backend_policy=%s block_edit_validation=%s block_edit_save_failure_rollback=%s unknown_packet_policy=%s nil_packet_policy=%s nil_position_policy=%s nil_block_action_policy=%s conflict_semantics=%s worldgen_biome_atlas_tile_identity=%s worldgen_biome_atlas_block_texture_usage=%s overload_status=%s runtime_reconnect=%s reconnect_smoke_status=%s reconnect_soak_status=%s slow_client_status=%s slow_reader_smoke_status=%s slow_reader_matrix_status=%s local_server_exposure=%s smoke_bind_exposure=%s source=%s\n' "$security_status" "$security_protocol_change" "$security_observability_gpu_report_freshness" "$security_storage_package_smoke" "$security_packet_error_monitoring" "$security_server_session_monitoring" "$security_storage_config" "$security_storage_backend_policy" "$security_block_edit_validation" "$security_block_edit_save_failure_rollback" "$security_unknown_packet_policy" "$security_nil_packet_policy" "$security_nil_position_policy" "$security_nil_block_action_policy" "$security_conflict_semantics" "$security_worldgen_biome_atlas_tile_identity" "$security_worldgen_biome_atlas_block_texture_usage" "$security_overload_status" "$security_runtime_reconnect" "$security_reconnect_smoke_status" "$security_reconnect_soak_status" "$security_slow_client_status" "$security_slow_reader_smoke_status" "$security_slow_reader_matrix_status" "$security_local_server_exposure" "$security_smoke_bind_exposure" "$SECURITY_SUMMARY"
  printf 'row=docs_reproducible_gates observability_status=%s architecture_status=%s handoff_status=%s handoff_gpu_report_freshness=%s rc_status=%s rc_test_gpu_report_freshness=%s rc_security_deterministic_property_tests=%s rc_security_observability_gpu_report_freshness=%s rc_security_storage_package_smoke=%s rc_security_packet_error_monitoring=%s rc_security_server_session_monitoring=%s rc_security_storage_config=%s rc_security_storage_backend_policy=%s rc_security_block_edit_validation=%s rc_security_block_edit_save_failure_rollback=%s rc_security_unknown_packet_policy=%s rc_security_nil_packet_policy=%s rc_security_nil_position_policy=%s rc_security_nil_block_action_policy=%s rc_security_conflict_semantics=%s rc_security_worldgen_biome_atlas_tile_identity=%s rc_security_worldgen_biome_atlas_block_texture_usage=%s rc_security_overload_status=%s rc_security_runtime_reconnect=%s rc_security_reconnect_smoke_status=%s rc_security_reconnect_soak_status=%s rc_security_slow_client_status=%s rc_security_slow_reader_smoke_status=%s rc_security_slow_reader_matrix_status=%s rc_security_local_server_exposure=%s rc_security_smoke_bind_exposure=%s\n' "$observability_status" "$arch_status" "$handoff_status" "$handoff_gpu_report_freshness" "$rc_status" "$rc_test_gpu_report_freshness" "$rc_security_deterministic_property_tests" "$rc_security_observability_gpu_report_freshness" "$rc_security_storage_package_smoke" "$rc_security_packet_error_monitoring" "$rc_security_server_session_monitoring" "$rc_security_storage_config" "$rc_security_storage_backend_policy" "$rc_security_block_edit_validation" "$rc_security_block_edit_save_failure_rollback" "$rc_security_unknown_packet_policy" "$rc_security_nil_packet_policy" "$rc_security_nil_position_policy" "$rc_security_nil_block_action_policy" "$rc_security_conflict_semantics" "$rc_security_worldgen_biome_atlas_tile_identity" "$rc_security_worldgen_biome_atlas_block_texture_usage" "$rc_security_overload_status" "$rc_security_runtime_reconnect" "$rc_security_reconnect_smoke_status" "$rc_security_reconnect_soak_status" "$rc_security_slow_client_status" "$rc_security_slow_reader_smoke_status" "$rc_security_slow_reader_matrix_status" "$rc_security_local_server_exposure" "$rc_security_smoke_bind_exposure"
  printf 'row=external_profiler status=%s capture_readiness=%s external_profile_status=%s rc_test_gpu_report_freshness=%s rc_security_observability_gpu_report_freshness=%s rc_security_storage_package_smoke=%s rc_security_packet_error_monitoring=%s rc_security_server_session_monitoring=%s rc_security_storage_config=%s rc_security_storage_backend_policy=%s rc_security_block_edit_validation=%s rc_security_block_edit_save_failure_rollback=%s rc_security_unknown_packet_policy=%s rc_security_nil_packet_policy=%s rc_security_nil_position_policy=%s rc_security_nil_block_action_policy=%s rc_security_conflict_semantics=%s rc_security_worldgen_biome_atlas_tile_identity=%s rc_security_worldgen_biome_atlas_block_texture_usage=%s rc_security_overload_status=%s rc_security_runtime_reconnect=%s rc_security_reconnect_smoke_status=%s rc_security_reconnect_soak_status=%s rc_security_slow_client_status=%s rc_security_slow_reader_smoke_status=%s rc_security_slow_reader_matrix_status=%s rc_security_local_server_exposure=%s rc_security_smoke_bind_exposure=%s source=%s\n' "$external_status" "$external_capture_readiness" "$external_profile_status" "$external_rc_test_gpu_report_freshness" "$external_rc_security_observability_gpu_report_freshness" "$external_rc_security_storage_package_smoke" "$external_rc_security_packet_error_monitoring" "$external_rc_security_server_session_monitoring" "$external_rc_security_storage_config" "$external_rc_security_storage_backend_policy" "$external_rc_security_block_edit_validation" "$external_rc_security_block_edit_save_failure_rollback" "$external_rc_security_unknown_packet_policy" "$external_rc_security_nil_packet_policy" "$external_rc_security_nil_position_policy" "$external_rc_security_nil_block_action_policy" "$external_rc_security_conflict_semantics" "$external_rc_security_worldgen_biome_atlas_tile_identity" "$external_rc_security_worldgen_biome_atlas_block_texture_usage" "$external_rc_security_overload_status" "$external_rc_security_runtime_reconnect" "$external_rc_security_reconnect_smoke_status" "$external_rc_security_reconnect_soak_status" "$external_rc_security_slow_client_status" "$external_rc_security_slow_reader_smoke_status" "$external_rc_security_slow_reader_matrix_status" "$external_rc_security_local_server_exposure" "$external_rc_security_smoke_bind_exposure" "$EXTERNAL_PROFILING_SUMMARY"
...
awk \
  ...
  -v security_observability_gpu_report_freshness="${security_observability_gpu_report_freshness:-missing}" \
  ...
  -v security_worldgen_biome_atlas_tile_identity="${security_worldgen_biome_atlas_tile_identity:-missing}" \
  -v security_worldgen_biome_atlas_block_texture_usage="${security_worldgen_biome_atlas_block_texture_usage:-missing}" \
  -v security_overload_status="${security_overload_status:-missing}" \
  -v security_runtime_reconnect="${security_runtime_reconnect:-missing}" \
  -v security_reconnect_smoke_status="${security_reconnect_smoke_status:-missing}" \
  -v security_reconnect_smoke_client_state="${security_reconnect_smoke_client_state:-missing}" \
  -v security_reconnect_smoke_reader_errors="${security_reconnect_smoke_reader_errors:-0}" \
  -v security_reconnect_smoke_successes="${security_reconnect_smoke_successes:-0}" \
  -v security_reconnect_soak_status="${security_reconnect_soak_status:-missing}" \
  -v security_reconnect_soak_cycles="${security_reconnect_soak_cycles:-0}" \
  -v security_reconnect_soak_reader_errors="${security_reconnect_soak_reader_errors:-0}" \
  -v security_reconnect_soak_successes="${security_reconnect_soak_successes:-0}" \
  -v security_slow_client_status="${security_slow_client_status:-missing}" \
  -v security_slow_reader_smoke_status="${security_slow_reader_smoke_status:-missing}" \
  -v security_slow_reader_timeout_observed="${security_slow_reader_timeout_observed:-0}" \
  -v security_slow_reader_timeout_class="${security_slow_reader_timeout_class:-missing}" \
  -v security_slow_reader_matrix_status="${security_slow_reader_matrix_status:-missing}" \
  -v security_slow_reader_matrix_counts_checked="${security_slow_reader_matrix_counts_checked:-0}" \
  -v security_slow_reader_matrix_max_fast_clients="${security_slow_reader_matrix_max_fast_clients:-0}" \
  -v security_slow_reader_matrix_total_fast_clients="${security_slow_reader_matrix_total_fast_clients:-0}" \
  -v security_slow_reader_matrix_total_fast_bootstrap_chunks="${security_slow_reader_matrix_total_fast_bootstrap_chunks:-0}" \
  -v security_slow_reader_matrix_total_slow_timeouts="${security_slow_reader_matrix_total_slow_timeouts:-0}" \
  ...
  -v rc_security_observability_gpu_report_freshness="${rc_security_observability_gpu_report_freshness:-missing}" \
  ...
  -v external_rc_security_observability_gpu_report_freshness="${external_rc_security_observability_gpu_report_freshness:-missing}" \
  ...
  -v external_rc_security_worldgen_biome_atlas_tile_identity="${external_rc_security_worldgen_biome_atlas_tile_identity:-missing}" \
  -v external_rc_security_worldgen_biome_atlas_block_texture_usage="${external_rc_security_worldgen_biome_atlas_block_texture_usage:-missing}" \
  -v external_rc_security_overload_status="${external_rc_security_overload_status:-missing}" \
  -v external_rc_security_runtime_reconnect="${external_rc_security_runtime_reconnect:-missing}" \
  -v external_rc_security_reconnect_smoke_status="${external_rc_security_reconnect_smoke_status:-missing}" \
  -v external_rc_security_reconnect_smoke_client_state="${external_rc_security_reconnect_smoke_client_state:-missing}" \
  -v external_rc_security_reconnect_smoke_reader_errors="${external_rc_security_reconnect_smoke_reader_errors:-0}" \
  -v external_rc_security_reconnect_smoke_successes="${external_rc_security_reconnect_smoke_successes:-0}" \
  -v external_rc_security_reconnect_soak_status="${external_rc_security_reconnect_soak_status:-missing}" \
  -v external_rc_security_reconnect_soak_cycles="${external_rc_security_reconnect_soak_cycles:-0}" \
  -v external_rc_security_reconnect_soak_reader_errors="${external_rc_security_reconnect_soak_reader_errors:-0}" \
  -v external_rc_security_reconnect_soak_successes="${external_rc_security_reconnect_soak_successes:-0}" \
  -v external_rc_security_slow_client_status="${external_rc_security_slow_client_status:-missing}" \
  -v external_rc_security_slow_reader_smoke_status="${external_rc_security_slow_reader_smoke_status:-missing}" \
  -v external_rc_security_slow_reader_timeout_observed="${external_rc_security_slow_reader_timeout_observed:-0}" \
  -v external_rc_security_slow_reader_timeout_class="${external_rc_security_slow_reader_timeout_class:-missing}" \
  -v external_rc_security_slow_reader_matrix_status="${external_rc_security_slow_reader_matrix_status:-missing}" \
  -v external_rc_security_slow_reader_matrix_counts_checked="${external_rc_security_slow_reader_matrix_counts_checked:-0}" \
  -v external_rc_security_slow_reader_matrix_max_fast_clients="${external_rc_security_slow_reader_matrix_max_fast_clients:-0}" \
  -v external_rc_security_slow_reader_matrix_total_fast_clients="${external_rc_security_slow_reader_matrix_total_fast_clients:-0}" \
  -v external_rc_security_slow_reader_matrix_total_fast_bootstrap_chunks="${external_rc_security_slow_reader_matrix_total_fast_bootstrap_chunks:-0}" \
  -v external_rc_security_slow_reader_matrix_total_slow_timeouts="${external_rc_security_slow_reader_matrix_total_slow_timeouts:-0}" \
  ...
  BEGIN {
    ...
    security_reconnect_ok = security_runtime_reconnect == "repeated_live_rebootstrap_guarded" &&
      security_reconnect_smoke_status == "pass" &&
      security_reconnect_smoke_client_state == "active" &&
      security_reconnect_smoke_reader_errors + 0 >= 1 &&
      security_reconnect_smoke_successes + 0 >= 1 &&
      security_reconnect_soak_status == "pass" &&
      security_reconnect_soak_cycles + 0 >= 2 &&
      security_reconnect_soak_reader_errors + 0 >= security_reconnect_soak_cycles + 0 &&
      security_reconnect_soak_successes + 0 >= security_reconnect_soak_cycles + 0
    security_slow_reader_ok = security_slow_client_status == "load_matrix_guarded" &&
      security_slow_reader_smoke_status == "pass" &&
      security_slow_reader_timeout_observed + 0 == 1 &&
      security_slow_reader_timeout_class == "timeout" &&
      security_slow_reader_matrix_status == "pass" &&
      security_slow_reader_matrix_counts_checked + 0 >= 2 &&
      security_slow_reader_matrix_max_fast_clients + 0 >= 2 &&
      security_slow_reader_matrix_total_fast_clients + 0 == security_slow_reader_matrix_total_fast_bootstrap_chunks + 0 &&
      security_slow_reader_matrix_total_slow_timeouts + 0 == security_slow_reader_matrix_counts_checked + 0
    ...
    external_reconnect_ok = external_rc_security_runtime_reconnect == "repeated_live_rebootstrap_guarded" &&
      external_rc_security_reconnect_smoke_status == "pass" &&
      external_rc_security_reconnect_smoke_client_state == "active" &&
      external_rc_security_reconnect_smoke_reader_errors + 0 >= 1 &&
      external_rc_security_reconnect_smoke_successes + 0 >= 1 &&
      external_rc_security_reconnect_soak_status == "pass" &&
      external_rc_security_reconnect_soak_cycles + 0 >= 2 &&
      external_rc_security_reconnect_soak_reader_errors + 0 >= external_rc_security_reconnect_soak_cycles + 0 &&
      external_rc_security_reconnect_soak_successes + 0 >= external_rc_security_reconnect_soak_cycles + 0
    external_slow_reader_ok = external_rc_security_slow_client_status == "load_matrix_guarded" &&
      external_rc_security_slow_reader_smoke_status == "pass" &&
      external_rc_security_slow_reader_timeout_observed + 0 == 1 &&
      external_rc_security_slow_reader_timeout_class == "timeout" &&
      external_rc_security_slow_reader_matrix_status == "pass" &&
      external_rc_security_slow_reader_matrix_counts_checked + 0 >= 2 &&
      external_rc_security_slow_reader_matrix_max_fast_clients + 0 >= 2 &&
      external_rc_security_slow_reader_matrix_total_fast_clients + 0 == external_rc_security_slow_reader_matrix_total_fast_bootstrap_chunks + 0 &&
      external_rc_security_slow_reader_matrix_total_slow_timeouts + 0 == external_rc_security_slow_reader_matrix_counts_checked + 0
    ...
    printf("production_readiness_milestone status=%s reason=%s production_readiness=%s stable_streaming=%s high_resident_set=%s predictable_performance=%s resource_upload_health=%s storage_protocol_integrity=%s docs_reproducible_gates=%s handoff_gpu_report_freshness=%s external_profiler=%s external_capture_readiness=%s external_rc_test_gpu_report_freshness=%s external_rc_security_observability_gpu_report_freshness=%s external_rc_security_storage_package_smoke=%s external_rc_security_packet_error_monitoring=%s external_rc_security_server_session_monitoring=%s external_rc_security_storage_config=%s external_rc_security_storage_backend_policy=%s external_rc_security_block_edit_validation=%s external_rc_security_block_edit_save_failure_rollback=%s external_rc_security_unknown_packet_policy=%s external_rc_security_nil_packet_policy=%s external_rc_security_nil_position_policy=%s external_rc_security_nil_block_action_policy=%s external_rc_security_conflict_semantics=%s external_rc_security_worldgen_biome_atlas_tile_identity=%s external_rc_security_worldgen_biome_atlas_block_texture_usage=%s external_rc_security_overload_status=%s external_rc_security_runtime_reconnect=%s external_rc_security_reconnect_smoke_status=%s external_rc_security_reconnect_soak_status=%s external_rc_security_slow_client_status=%s external_rc_security_slow_reader_smoke_status=%s external_rc_security_slow_reader_matrix_status=%s external_rc_security_local_server_exposure=%s external_rc_security_smoke_bind_exposure=%s native_shadow_direction=%s transparent_direction=%s live_release_checks=%s rc_test_gpu_report_freshness=%s rc_security_deterministic_property_tests=%s rc_security_observability_gpu_report_freshness=%s security_observability_gpu_report_freshness=%s security_storage_package_smoke=%s security_packet_error_monitoring=%s security_server_session_monitoring=%s security_storage_config=%s security_storage_backend_policy=%s security_block_edit_validation=%s security_block_edit_save_failure_rollback=%s security_unknown_packet_policy=%s security_nil_packet_policy=%s security_nil_position_policy=%s security_nil_block_action_policy=%s security_conflict_semantics=%s security_worldgen_biome_atlas_tile_identity=%s security_worldgen_biome_atlas_block_texture_usage=%s security_overload_status=%s security_runtime_reconnect=%s security_reconnect_smoke_status=%s security_reconnect_soak_status=%s security_slow_client_status=%s security_slow_reader_smoke_status=%s security_slow_reader_matrix_status=%s security_local_server_exposure=%s security_smoke_bind_exposure=%s rc_security_storage_package_smoke=%s rc_security_packet_error_monitoring=%s rc_security_server_session_monitoring=%s rc_security_storage_config=%s rc_security_storage_backend_policy=%s rc_security_block_edit_validation=%s rc_security_block_edit_save_failure_rollback=%s rc_security_unknown_packet_policy=%s rc_security_nil_packet_policy=%s rc_security_nil_position_policy=%s rc_security_nil_block_action_policy=%s rc_security_conflict_semantics=%s rc_security_worldgen_biome_atlas_tile_identity=%s rc_security_worldgen_biome_atlas_block_texture_usage=%s rc_security_overload_status=%s rc_security_runtime_reconnect=%s rc_security_reconnect_smoke_status=%s rc_security_reconnect_soak_status=%s rc_security_slow_client_status=%s rc_security_slow_reader_smoke_status=%s rc_security_slow_reader_matrix_status=%s rc_security_local_server_exposure=%s rc_security_smoke_bind_exposure=%s resident_gpu_draws=%d resident_gpu_subchunks=%d upload_effective_draws=%d memory_fragmentation_pct=%.3f report=%s rc_summary=%s external_summary=%s\n", status, reason, production_readiness, stable_streaming, high_resident_set, predictable_performance, resource_upload_health, storage_protocol_integrity, docs_reproducible_gates, handoff_gpu_report_freshness, external_profiler, external_capture_readiness, external_rc_test_gpu_report_freshness, external_rc_security_observability_gpu_report_freshness, external_rc_security_storage_package_smoke, external_rc_security_packet_error_monitoring, external_rc_security_server_session_monitoring, external_rc_security_storage_config, external_rc_security_storage_backend_policy, external_rc_security_block_edit_validation, external_rc_security_block_edit_save_failure_rollback, external_rc_security_unknown_packet_policy, external_rc_security_nil_packet_policy, external_rc_security_nil_position_policy, external_rc_security_nil_block_action_policy, external_rc_security_conflict_semantics, external_rc_security_worldgen_biome_atlas_tile_identity, external_rc_security_worldgen_biome_atlas_block_texture_usage, external_rc_security_overload_status, external_rc_security_runtime_reconnect, external_rc_security_reconnect_smoke_status, external_rc_security_reconnect_soak_status, external_rc_security_slow_client_status, external_rc_security_slow_reader_smoke_status, external_rc_security_slow_reader_matrix_status, external_rc_security_local_server_exposure, external_rc_security_smoke_bind_exposure, native_shadow_direction, transparent_direction, rc_live_checks, rc_test_gpu_report_freshness, rc_security_deterministic_property_tests, rc_security_observability_gpu_report_freshness, security_observability_gpu_report_freshness, security_storage_package_smoke, security_packet_error_monitoring, security_server_session_monitoring, security_storage_config, security_storage_backend_policy, security_block_edit_validation, security_block_edit_save_failure_rollback, security_unknown_packet_policy, security_nil_packet_policy, security_nil_position_policy, security_nil_block_action_policy, security_conflict_semantics, security_worldgen_biome_atlas_tile_identity, security_worldgen_biome_atlas_block_texture_usage, security_overload_status, security_runtime_reconnect, security_reconnect_smoke_status, security_reconnect_soak_status, security_slow_client_status, security_slow_reader_smoke_status, security_slow_reader_matrix_status, security_local_server_exposure, security_smoke_bind_exposure, rc_security_storage_package_smoke, rc_security_packet_error_monitoring, rc_security_server_session_monitoring, rc_security_storage_config, rc_security_storage_backend_policy, rc_security_block_edit_validation, rc_security_block_edit_save_failure_rollback, rc_security_unknown_packet_policy, rc_security_nil_packet_policy, rc_security_nil_position_policy, rc_security_nil_block_action_policy, rc_security_conflict_semantics, rc_security_worldgen_biome_atlas_tile_identity, rc_security_worldgen_biome_atlas_block_texture_usage, rc_security_overload_status, rc_security_runtime_reconnect, rc_security_reconnect_smoke_status, rc_security_reconnect_soak_status, rc_security_slow_client_status, rc_security_slow_reader_smoke_status, rc_security_slow_reader_matrix_status, rc_security_local_server_exposure, rc_security_smoke_bind_exposure, resident_gpu_draws, load_subchunks, upload_effective_draws, memory_fragmentation, report_path, rc_summary, external_summary)
    if (status != "pass") {
      exit 1
    }
  }
