...

{
  ...
  printf 'row=storage_protocol_integrity status=%s active_protocol_change=%s block_edit_validation=%s unknown_packet_policy=%s nil_packet_policy=%s nil_position_policy=%s nil_block_action_policy=%s conflict_semantics=%s local_server_exposure=%s smoke_bind_exposure=%s source=%s\n' "$security_status" "$security_protocol_change" "$security_block_edit_validation" "$security_unknown_packet_policy" "$security_nil_packet_policy" "$security_nil_position_policy" "$security_nil_block_action_policy" "$security_conflict_semantics" "$security_local_server_exposure" "$security_smoke_bind_exposure" "$SECURITY_SUMMARY"
  printf 'row=docs_reproducible_gates observability_status=%s architecture_status=%s handoff_status=%s rc_status=%s rc_security_deterministic_property_tests=%s rc_security_block_edit_validation=%s rc_security_unknown_packet_policy=%s rc_security_nil_packet_policy=%s rc_security_nil_position_policy=%s rc_security_nil_block_action_policy=%s rc_security_conflict_semantics=%s rc_security_local_server_exposure=%s rc_security_smoke_bind_exposure=%s\n' "$observability_status" "$arch_status" "$handoff_status" "$rc_status" "$rc_security_deterministic_property_tests" "$rc_security_block_edit_validation" "$rc_security_unknown_packet_policy" "$rc_security_nil_packet_policy" "$rc_security_nil_position_policy" "$rc_security_nil_block_action_policy" "$rc_security_conflict_semantics" "$rc_security_local_server_exposure" "$rc_security_smoke_bind_exposure"
  printf 'row=external_profiler status=%s capture_readiness=%s external_profile_status=%s rc_security_block_edit_validation=%s rc_security_unknown_packet_policy=%s rc_security_nil_packet_policy=%s rc_security_nil_position_policy=%s rc_security_nil_block_action_policy=%s rc_security_conflict_semantics=%s rc_security_local_server_exposure=%s rc_security_smoke_bind_exposure=%s source=%s\n' "$external_status" "$external_capture_readiness" "$external_profile_status" "$external_rc_security_block_edit_validation" "$external_rc_security_unknown_packet_policy" "$external_rc_security_nil_packet_policy" "$external_rc_security_nil_position_policy" "$external_rc_security_nil_block_action_policy" "$external_rc_security_conflict_semantics" "$external_rc_security_local_server_exposure" "$external_rc_security_smoke_bind_exposure" "$EXTERNAL_PROFILING_SUMMARY"
