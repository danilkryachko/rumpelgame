...

{
  ...
  printf 'rc_input status=%s live_checks=%s security_deterministic_property_tests=%s security_conflict_semantics=%s security_local_server_exposure=%s security_smoke_bind_exposure=%s summary=%s\n' \
    "$rc_status" \
    "$rc_live_checks" \
