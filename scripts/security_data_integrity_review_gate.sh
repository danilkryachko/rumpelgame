...
for token in \
  ...
  'packet_error_class=' \
  'serverBlockActionReach' \
  'blockActionInReach' \
  'blockActionIntersectsPlayer' \
  'world.IsPlaceable' \
  'SetBlockGlobal'; do
...
require_token "$SERVER_NETWORK_BEHAVIOR_TEST" 'TestHandleClientPacketRejectsBlockActionBeforePosition'
require_token "$SERVER_NETWORK_BEHAVIOR_TEST" 'TestHandleClientPacketRejectsOutOfReachBlockAction'
require_token "$SERVER_NETWORK_BEHAVIOR_TEST" 'TestHandleClientPacketRejectsPlaceInsidePlayer'
require_token "$SERVER_NETWORK_BEHAVIOR_TEST" 'TestBlockActionWithinReachRequiresPositionAndBoundedDistance'
require_token "$SERVER_NETWORK_BEHAVIOR_TEST" 'TestBlockActionIntersectsPlayerMatchesClientAABB'
...
awk \
  ...
  BEGIN {
    ...
    block_edit_reach = "position_guarded"
    block_edit_player_collision = "place_player_aabb_guarded"
