...
WINDOWS_CAPTURE_PACK_SUMMARY="${RUMPELMC_GPU_STRESS_INDEX_WINDOWS_CAPTURE_PACK_SUMMARY:-"$ROOT_DIR/logs/gpu_windows_capture_pack_current/gpu-windows-capture-pack-summary.txt"}"
WINDOWS_CAPTURE_RESULTS_SUMMARY="${RUMPELMC_GPU_STRESS_INDEX_WINDOWS_CAPTURE_RESULTS_SUMMARY:-"$ROOT_DIR/logs/gpu_windows_capture_pack_current/gpu-windows-capture-results-summary.txt"}"
...
record_artifact windows_capture_pack external_profiler 1 status pass "$WINDOWS_CAPTURE_PACK_SUMMARY"
record_artifact windows_capture_results external_profiler 0 status pass "$WINDOWS_CAPTURE_RESULTS_SUMMARY"
