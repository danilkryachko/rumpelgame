...
FALLBACK_SUMMARY="${RUMPELMC_NATIVE_SHADOW_PREFLIGHT_FALLBACK_SUMMARY:-"$ROOT_DIR/logs/gpu_native_shadow_summary_fields_20260614/movement-stress-summary.txt"}"
